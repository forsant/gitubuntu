...
echo '<img src="images/requette-php-base3.png"><br/>';
...
echo "<b>3.Afficher toutes les personnes par ordre décroissant<br/></b>";
echo '<img src="images/requette-php-base4.png"><br/>';
...
// Affichage des résultats  // Bien respecter les lettres capitales et minuscules
...
mysqli_close($cnx); // Fermez la connexion lorsque vous avez terminé.
}
echo "<br/><br/>";
...
echo "<b>Suite de tirage de nombre aléatoires jusqu'à une suite<br/>";
echo "d'un nombre pair et de deux nombres impaires</b>";
echo "<br/><br/>";
echo "<b>Avec While<br/></b>";
echo '<img src="images/tp_php_n_8.png"><br/><br/>';

// Crée un tableau vide pour stocker la séquence de nombres.
$sequence = []; 

while (count($sequence) < 3 || 
    !($sequence[count($sequence)- 3] % 2 == 0
    && $sequence[count($sequence) - 2] % 2 == 1
    && $sequence[count($sequence) - 1] % 2 == 1))
{
...
echo "<b>Avec do while</b><br/>";
echo '<img src="images/tp_php_n_9.png"><br/>';

$sequence = [];// Crée un tableau vide pour stocker
// la séquence de nombres.
// Génération d'un nombre pair aléatoire
do {// Génère un nombre aléatoire entre 1 et 100.
    $randomNumber = rand(1, 100);

// Ajoute le nombre aléatoire à la fin de la séquence.
...
/** La boucle continue tant que la séquence a moins
 *  de 3 éléments ou que les trois derniers éléments
 *  de la séquence ne forment pas * la séquence souhaitée
...
echo "<b>Créer et afficher des numéros d'imat. (pour Paris) en commençant par 100 PHP 75</b>";
echo "<br/>";
echo '<img src="images/tp_php_n_10.png"><br/><br/>';

$numImmatriculation = "100 PHP 75"; // Numéro d'immatriculation initial

// Affiche les numéros d'immatriculation pour Paris en incrémentant
// à partir de 100
// Changez le nombre d'itérations selon vos besoins
for ($i = 1; $i <= 6; $i++) { 
    echo $numImmatriculation . " | ";
    
    // Incrémente le numéro d'immatriculation
    //  (en supposant que le numéro de départ soit sous forme de chaîne)
...
echo "<b>Choisissez un nombre de 3 chiffres et aléatoirement tirer d'autre chiffres<br/>";
echo " et compter le nombre de coup pour obtenir le nombre du départ avec while<br/>";
...
echo "<b>Choisissez un nombre de 3 chiffres et aléatoirement tirer d'autre chiffres<br/>";
echo "et compter le nombre de coup pour obtenir le nombre du départ avec for<br/>";
...
echo "Créer un tableau dont les indices varient de 11 à 36 et les valeurs sont<br/>";
echo " des lettres de A à Z</b><br/>";
echo "<b>Affiche le tabelau avec la boucle FOREACH</b><br/>";
...
echo " , <br/><br/>";
echo "Créer un tableau dont les indices varient de 11 à 36 et les valeurs sont<br/>";
echo " des lettres de A à Z<br/>";
echo "<b>Affiche le tabelau avec la boucle FOR</b><br/>";
...
echo "<br/>";
echo "<b>Utiliser une boucle while pour déterminer le premier entier par tirage<br/>";
echo" au sort aléatoire qui soit un multiple d'un nombre donné</b><br/>";
echo '<img src="images/tp_php_n17.png"><br/><br/>';

// Remplacez le nombre donné par celui de votre choix
$nombreDonne = 7; 
 // Initialisation de la variable pour stocker le premier multiple
...
echo "Le premier multiple de $nombreDonne est $premierMultiple,
     obtenu après $tirages tirages aléatoires.";
echo "<br/><br/>";
